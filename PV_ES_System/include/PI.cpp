 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Aug 25 21:56:57 2024
 */
...
extern void PI_Start_wrapper(void);
extern void PI_Outputs_wrapper(const real_T *Vo_e,
  const real_T *Vo_m,
  real_T *Vo_pi);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vo_e of S-Function PI");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vo_m of S-Function PI");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Vo_pi of S-Function PI");
      return;
    }
...
{
  const real_T *Vo_e = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Vo_m = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *Vo_pi = (real_T *) ssGetOutputPortRealSignal(S, 0);
  PI_Outputs_wrapper(Vo_e, Vo_m, Vo_pi);
}
