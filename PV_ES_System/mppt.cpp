 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Aug 25 09:00:10 2024
 */
...
extern void mppt_Start_wrapper(void);
extern void mppt_Outputs_wrapper(const real_T *IpvRead,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port IpvRead of S-Function mppt");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port VpvRead of S-Function mppt");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function mppt");
      return;
    }
...
{
  const real_T *IpvRead = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *VpvRead = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *y0 = (real_T *) ssGetOutputPortRealSignal(S, 0);
  mppt_Outputs_wrapper(IpvRead, VpvRead, y0);
}
