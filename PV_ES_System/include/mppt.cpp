 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sun Aug 25 22:16:07 2024
 */
...
extern void mppt_Outputs_wrapper(const real_T *Vpv,
  const real_T *Ipv,
  real_T *y0);
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Vpv of S-Function mppt");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Ipv of S-Function mppt");
      return;
    }
...
{
  const real_T *Vpv = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *Ipv = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *y0 = (real_T *) ssGetOutputPortRealSignal(S, 0);
  mppt_Outputs_wrapper(Vpv, Ipv, y0);
}
